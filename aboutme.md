...
My name is Weiyuan Gong (龚维元), and I'm currently a graduate student at SEAS, Harvard University, where I have the privilege of working with [Prof. Sitan Chen](https://sitanchen.com/). My research primarily focuses on the applications of theory for algorithms and machine learning in the physical world. Prior to my studies at Harvard, I completed my B.E. at IIIS (Yao Class), Tsinghua University, under the guidance of [Prof. Dong-Ling Deng](https://iiis.tsinghua.edu.cn/en/People/Faculty/DengDongling.htm).
